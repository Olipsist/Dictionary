...
public class DetailFragment extends Fragment {
    ...
    private DetailCursorAdapter adapter;
...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Toast.makeText(inflater.getContext(),mParam1,Toast.LENGTH_SHORT).show();
        initView(inflater.getContext(), rootView);
        Cursor cursor = helper.findWordsDetailByString(db,mParam1);
        cursor.moveToFirst();
        adapter = new DetailCursorAdapter(inflater.getContext(),cursor,0);
        detailListView.setAdapter(adapter);
        wordTextView.setText(mParam1);
